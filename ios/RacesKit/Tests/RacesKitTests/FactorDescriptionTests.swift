...
final class FactorDescriptionTests: XCTestCase {
    ...
    func test_theDeliberateZerosAreExactlyTheOnesDocumented() {
        ...
        XCTAssertEqual(zeroed, [.draw, .headgear, .jockeyStrikeRate, .trainerStrikeRate, .jockeySurfaceStrikeRate, .trainerSurfaceStrikeRate, .jockeyRaceTypeStrikeRate, .trainerRaceTypeStrikeRate, .jockeyGoingStrikeRate, .trainerGoingStrikeRate, .horseGoingPlaceRate, .jockeyRecentStrikeRate, .trainerRecentStrikeRate, .jockeyTrainerStrikeRate, .classAdjustedForm, .marketMovement])
