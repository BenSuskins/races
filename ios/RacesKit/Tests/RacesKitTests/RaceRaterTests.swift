...
final class RaceRaterTests: XCTestCase {
    ...
    func test_zeroWeightFactorsHaveNoEffect() throws {
        ...
        for id in [FactorID.draw, .headgear, .jockeyStrikeRate, .trainerStrikeRate, .jockeySurfaceStrikeRate, .trainerSurfaceStrikeRate, .jockeyRaceTypeStrikeRate, .trainerRaceTypeStrikeRate] {
